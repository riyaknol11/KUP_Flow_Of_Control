        ...
        public static void main(String[] args) {
            ...
            for (Shape index : Shape.values() )
                ...
                if(index == Shape.CIRCLE){
                    ...
                    System.out.println(circleArea(radius, area));
                }
                else if(index == Shape.SQUARE) {
                    System.out.println("Enter the side for square :");
                    int side = input.nextInt();
                    System.out.println(squareArea(side,area));
                }
                    ...
                    System.out.println(rectangleArea(length, width, area));
                }
                else{
                    ...
                    System.out.println(triangleArea(base, height, area));
                }
